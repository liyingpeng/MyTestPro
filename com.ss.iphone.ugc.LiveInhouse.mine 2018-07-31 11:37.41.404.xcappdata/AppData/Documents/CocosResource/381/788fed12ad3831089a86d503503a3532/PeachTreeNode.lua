...
sprites[10]:setGlobalZOrder(989)
...
sprites[11]:setGlobalZOrder(990)
...
sprites[12]:setGlobalZOrder(991)
...
sprites[13]:setGlobalZOrder(992)
...
sprites[14]:setGlobalZOrder(993)
...
sprites[15]:setGlobalZOrder(994)
...
sprites[16]:setGlobalZOrder(995)
...
sprites[17]:setGlobalZOrder(996)
...
-- read particle file
    ...
    local _emitter_2 = cc.ParticleSystemQuad:create(self:getResourcePath("2.plist"))
        _emitter_2:setPosition(360,544)    -- position of particle
        :setVisible(false)
        :addTo(self)
    ...
    local _emitter_3 = cc.ParticleSystemQuad:create(self:getResourcePath("3.plist"))
        _emitter_3:setPosition(360,544)    -- position of particle
        :setVisible(false)
        :addTo(self)
