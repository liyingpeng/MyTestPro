...
sprites[10]:setGlobalZOrder(994)
...
sprites[11]:setGlobalZOrder(995)
...
sprites[12]:setGlobalZOrder(996)
...
sprites[13]:setGlobalZOrder(997)
...
sprites[14]:setGlobalZOrder(998)
...
for _, i in pairs({ 1, 2, 3, 5, 7 }) do
    ...
    fireworks[i]:addTo(sprites[1]):setGlobalZOrder(1000)
