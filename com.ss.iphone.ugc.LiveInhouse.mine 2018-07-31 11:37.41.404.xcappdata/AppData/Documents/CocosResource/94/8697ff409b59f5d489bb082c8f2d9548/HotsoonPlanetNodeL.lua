...
function HotsoonPlanetNode:init()
    display.loadSpriteFrames(self:getResourcePath("HotsoonPlanet.plist"), self:getResourcePath("HotsoonPlanet.png"))
    display.loadSpriteFrames(self:getResourcePath("HotsoonMouth.plist"), self:getResourcePath("HotsoonMouth.png"))
    display.loadSpriteFrames(self:getResourcePath("HotsoonBeerPeople.plist"), self:getResourcePath("HotsoonBeerPeople.png"))
    local size=display.size
    self:setVisible(true)

    local ownerAction = cc.Sequence:create({          --总时间5.5s
        cc.CallFunc:create(function(el,data)
            el:align(display.CENTER, display.cx, 0.7*display.height)
            el:setOpacity(0)
            el:setVisible(true)
        end),
    ...
    up:setScale(1.78, .562)
    up:setVisible(false)
    up:setPosition(0,size.height-up:getContentSize().height + 200)
    --左上方的外星球
    local planetOutside = display.newSprite("#Hotsoon_planet_outside.png")
    planetOutside:setVisible(false)
    planetOutside:setPosition(size.width/8,size.height/7)
    ...
    self.vocanoSmallMouthOffsetX = 15
    vocanoSmallMouth:setVisible(false)
    local vocanoSmallMouthAction = cc.Sequence:create({
        cc.CallFunc:create(function(el)
            el:setPosition(size.width*0.577 + self.vocanoSmallMouthOffsetX,planet:getContentSize().height*1.055)
        ...
        cc.RotateTo:create(0.2,0),
        cc.DelayTime:create(1.5),
        cc.MoveTo:create(0.3,cc.p(size.width*0.575 + self.vocanoSmallMouthOffsetX,-vocanoSmall:getContentSize().height*0.5)),
        cc.CallFunc:create(function(el)
            el:setVisible(false)
        end)
    })
    ...
    self.smallLavaOffsetX = 15
    vocanoSmallLava:setVisible(false)
    local vocanoSmallLavaAction = cc.Sequence:create({
        cc.DelayTime:create(4.6),
        cc.CallFunc:create(function(el)
            el:setPosition(size.width*0.587 + self.smallLavaOffsetX,planet:getContentSize().height*0.955)
            el:setAnchorPoint(0.5,0.5)
            el:setVisible(true)
        end),
        ...
        cc.MoveTo:create(0.3,cc.p(size.width*0.585 + self.smallLavaOffsetX,-vocanoSmall:getContentSize().height*0.5)),
        cc.CallFunc:create(function(el)
            el:setVisible(false)
        end)
    })
    ...
    self.vocanoBigLeftEyeOffsetX = 22
    vocanoBigLeftEye:setVisible(false)
    local vocanoBigLeftEyeAction = cc.Sequence:create({
        cc.CallFunc:create(function(el)
            el:setPosition(size.width*0.72 + self.vocanoBigLeftEyeOffsetX,planet:getContentSize().height*1.265)
            el:setAnchorPoint(0.5,0.5)
            el:setScale(0)
            el:setVisible(true)
        end),
        ...
        cc.EaseBackOut:create(cc.ScaleTo:create(0.2,1)),
        cc.CallFunc:create(function(el)
            el:setPosition(size.width*0.76 + self.vocanoBigLeftEyeOffsetX,planet:getContentSize().height*1)
        ...
        cc.RotateTo:create(0.2,0),
        cc.DelayTime:create(1.1),
        cc.MoveTo:create(0.3,cc.p(size.width*0.76 + self.vocanoBigLeftEyeOffsetX,-vocanoBig:getContentSize().height*0.5)),
        cc.CallFunc:create(function(el)
            el:setVisible(false)
        end)
    })
    ...
    self.vocanoBigRightEyeOffsetX = 18
    vocanoBigRightEye:setVisible(false)
    local vocanoBigRightEyeAction = cc.Sequence:create({
        cc.CallFunc:create(function(el)
            el:setPosition(size.width*0.826 + self.vocanoBigRightEyeOffsetX,planet:getContentSize().height*1.33)
            el:setAnchorPoint(0.5,0.5)
            el:setScale(0)
            el:setVisible(true)
        end),
        ...
        cc.EaseBackOut:create(cc.ScaleTo:create(0.2,1)),
        cc.CallFunc:create(function(el)
            el:setPosition(size.width*0.78 + self.vocanoBigRightEyeOffsetX,planet:getContentSize().height*1.07)
        ...
        cc.DelayTime:create(1),
        cc.CallFunc:create(function(el)
            el:setPosition(size.width*0.78 + self.vocanoBigRightEyeOffsetX,planet:getContentSize().height*1.33)
        ...
        cc.RotateTo:create(0.2,0),
        cc.DelayTime:create(1.1),
        cc.MoveTo:create(0.3,cc.p(size.width*0.78 + self.vocanoBigRightEyeOffsetX,-vocanoBig:getContentSize().height*0.5)),
        cc.CallFunc:create(function(el)
            el:setVisible(false)
        end)
    })
    ...
    self.vocanoBigMouthOffsetX = 20
    vocanoBigMouth:setVisible(false)
    local vocanoBigMouthAction = cc.Sequence:create({
        cc.CallFunc:create(function(el)
            el:setPosition(size.width*0.77 + self.vocanoBigMouthOffsetX,planet:getContentSize().height*1.05)
            el:setAnchorPoint(0.5,0.5)
            el:setScale(0)
            el:setVisible(true)
        end),
        ...
        cc.RotateTo:create(0.2,0),
        cc.DelayTime:create(1.1),
        cc.MoveTo:create(0.3,cc.p(size.width*0.77 + self.vocanoBigMouthOffsetX,-vocanoBig:getContentSize().height*0.5)),
        cc.CallFunc:create(function(el)
            el:setVisible(false)
        end)
    })
    ...
    vocanoBigLava:setLocalZOrder(-1)
    self.vocanoBiglavaOffsetX = 278
    self.vocanoBiglavaOffsetY = 240
    vocanoBigLava:setVisible(false)
    local vocanoBigLavaAction = cc.Sequence:create({
        cc.DelayTime:create(2.9),
        cc.CallFunc:create(function(el)
            el:setPosition(self.vocanoBiglavaOffsetX,self.vocanoBiglavaOffsetY)
            el:setAnchorPoint(0.5,0.5)
            el:setVisible(true)
        end),
        cc.Spawn:create({
   ...
   :setVisible(false)
    ...
    local beatPeopleRightHandAction = cc.Sequence:create({
       cc.CallFunc:create(function(el)
            el:setAnchorPoint(0,1)
            el:setPosition(10,vocano1Height*0.3)
            el:setScale(0)
            el:setVisible(true)
        end),
        cc.DelayTime:create(1.7),
    ...
    self.diamond2OffsetX = 10
    diamond2:setVisible(false)
    local clip = display.newSprite("#Hotsoon_jewelry2_clip.png")
    clip:setAnchorPoint(1,0)
    clip:setPosition(size.width + self.diamond2OffsetX,planet:getContentSize().height*0.07)
    ...
    local diamond2Action = cc.Sequence:create({
        ...
        cc.CallFunc:create(function(el)
            el:setAnchorPoint(0,0)
            el:setPosition(size.width*0.85 + self.diamond2OffsetX,diamond2:getContentSize().height-20)
            el:setVisible(true)
            clip:setVisible(true)
        end),
        cc.DelayTime:create(0.3),
        cc.MoveTo:create(0.4,cc.p(size.width*0.85 + self.diamond2OffsetX,planet:getContentSize().height*0.29)),
        cc.EaseBackOut:create(cc.MoveTo:create(0.1,cc.p(size.width*0.85 + self.diamond2OffsetX,planet:getContentSize().height*0.3))),
        cc.CallFunc:create(function(el)
            clip:setVisible(false)
        end),
        cc.DelayTime:create(7.2),
        cc.MoveTo:create(0.3,cc.p(size.width*0.85 + self.diamond2OffsetX,-100)),
        cc.CallFunc:create(function(el)
            el:setVisible(false)
        end)
    })
    ...
    local playButtonAction = cc.Sequence:create({
        ...
        cc.CallFunc:create(function(el)
            el:setAnchorPoint(0.5,0.5)
            el:setPosition(size.width*0.399,planet:getContentSize().height*1.21)
            el:setVisible(true)
        end),
        cc.DelayTime:create(1.8),
    ...
    local fireAction = cc.Sequence:create({
        ...
        cc.CallFunc:create(function(el)
            el:setAnchorPoint(0.5,0)
            el:setPosition(size.width*0.371,planet:getContentSize().height*0.995)
            el:setOpacity(100)
            el:setVisible(true)
        end),
        cc.FadeIn:create(0.2),
    ...
    local mountainAction = cc.Sequence:create({
        ...
        cc.CallFunc:create(function(el)
            el:setAnchorPoint(0.5,0)
            el:setPosition(size.width*0.3955,planet:getContentSize().height*1.038)
            el:setOpacity(50)
            el:setVisible(true)
        end),
        cc.DelayTime:create(0.9),
    ...
    local PAction = cc.Sequence:create({
        ...
        cc.CallFunc:create(function(el)
            el:setAnchorPoint(0.5,0)
            el:setPosition(size.width*0.411,planet:getContentSize().height*1.064)
            el:setOpacity(50)
            el:setVisible(true)
        end),
    ...
    local AAction = cc.Sequence:create({
        ...
        cc.CallFunc:create(function(el)
            el:setAnchorPoint(0.5,0)
            el:setPosition(size.width*0.421,planet:getContentSize().height*1.08)
            el:setOpacity(50)
            el:setVisible(true)
        end),
        cc.DelayTime:create(1),
    ...
    local RAction = cc.Sequence:create({
        ...
        cc.CallFunc:create(function(el)
            el:setAnchorPoint(0.5,0)
            el:setPosition(size.width*0.428,planet:getContentSize().height*1.0815)
            el:setOpacity(50)
            el:setVisible(true)
        end),
        cc.DelayTime:create(1),
    ...
    local TAction = cc.Sequence:create({
        ...
        cc.CallFunc:create(function(el)
            el:setAnchorPoint(0.5,0)
            el:setPosition(size.width*0.439,planet:getContentSize().height*1.115)
            el:setOpacity(50)
            el:setVisible(true)
        end),
        cc.DelayTime:create(1),
    ...
    local YAction = cc.Sequence:create({
        ...
        cc.CallFunc:create(function(el)
            el:setAnchorPoint(0.5,0)
            el:setScaleY(0.9)
            el:setPosition(size.width*0.4492,planet:getContentSize().height*1.14)
            el:setOpacity(50)
            el:setVisible(true)
        end),
        cc.DelayTime:create(0.8),
    ...
    self.audioLeftOffsetX = 66
    audioLeft:setVisible(false)
    local audioLeftAction = cc.Sequence:create({
        cc.DelayTime:create(2.5),
        cc.CallFunc:create(function(el)
            el:setAnchorPoint(0.5,0)
            el:setPosition(size.width*0.3 + self.audioLeftOffsetX,planet:getContentSize().height*0.6)
            el:setScale(0)
            el:setVisible(true)
        end),
        cc.EaseBackOut:create(cc.ScaleTo:create(0.3,1)),
        cc.DelayTime:create(0.5),
        cc.EaseOut:create(cc.MoveTo:create(0.3,cc.p(size.width*0.3 + self.audioLeftOffsetX,planet:getContentSize().height*0.67)),3),
        cc.EaseIn:create(cc.MoveTo:create(0.3,cc.p(size.width*0.3 + self.audioLeftOffsetX, planet:getContentSize().height*0.6)),3),
        cc.DelayTime:create(1.2),
        cc.EaseOut:create(cc.MoveTo:create(0.3,cc.p(size.width*0.3 + self.audioLeftOffsetX,planet:getContentSize().height*0.67)),3),
        cc.EaseIn:create(cc.MoveTo:create(0.3,cc.p(size.width*0.3 + self.audioLeftOffsetX,planet:getContentSize().height*0.6)),3),
        cc.DelayTime:create(3.2),
        cc.MoveTo:create(0.3,cc.p(size.width*0.3 + self.audioLeftOffsetX,-audioLeft:getContentSize().height)),
        cc.CallFunc:create(function(el)
            el:setVisible(false)
        end)
    })
    ...
    self.audioLeftShadowOffsetX = 80
    self.audioLeftShadowOffsetY = 0
    audioLeftShadow:setVisible(false)
    local audioLeftShadowAction = cc.Sequence:create({
        cc.DelayTime:create(2.5),
        cc.CallFunc:create(function(el)
            el:setAnchorPoint(0.5,0)
            el:setPosition(size.width*0.283 + self.audioLeftShadowOffsetX,planet:getContentSize().height*0.61 + self.audioLeftShadowOffsetY)
            el:setScale(0)
            el:setVisible(true)
        end),
        cc.EaseBackOut:create(cc.ScaleTo:create(0.3,1)),
        ...
        cc.EaseIn:create(cc.FadeIn:create(0.3),3),
        cc.DelayTime:create(3.2),
        cc.MoveTo:create(0.3,cc.p(size.width*0.3 + self.audioLeftShadowOffsetX,-audioLeft:getContentSize().height + self.audioLeftShadowOffsetY)),
        cc.CallFunc:create(function(el)
            el:setVisible(false)
        end)
    })
    ...
    local blowHatAction = cc.Sequence:create({
        ...
        cc.CallFunc:create(function(el)
            el:setAnchorPoint(0.5,-1)
            el:setPosition(size.width*0.04,blowHat:getContentSize().height * 0.8)
            el:setScale(0.3)
            el:setVisible(true)
        end),
        cc.ScaleTo:create(0.4,1),
    ...
    self.ufoPeopleOffsetY = .15 * size.height
    self.ufoOffsetY = .12 * size.height
    --ufo下部飞船
    ...
    ufoShadow:setPosition(size.width*0.93,size.height*0.127 + self.ufoOffsetY)
    local ufoAction = cc.Sequence:create({
        cc.DelayTime:create(0.3),
        cc.CallFunc:create(function(el)
            el:setAnchorPoint(0.5,0.5)
            el:setPosition(size.width*0.5,size.height*0.35 + self.ufoOffsetY)
            el:setScale(0)
            el:setVisible(true)
        end),
        cc.Spawn:create({
            cc.ScaleTo:create(0.4,1),
            cc.Sequence:create({
                cc.MoveTo:create(0.2,cc.p(size.width*0.8,size.height*0.45 + self.ufoOffsetY)),
                cc.MoveTo:create(0.1,cc.p(size.width*1.05,size.height*0.4 + self.ufoOffsetY)),
                cc.MoveTo:create(0.1,cc.p(size.width*1.1,size.height*0.3 + self.ufoOffsetY)),
                cc.MoveTo:create(0.1,cc.p(size.width*1,size.height*0.17 + self.ufoOffsetY)),
                cc.MoveTo:create(0.1,cc.p(size.width*0.9,size.height*0.14 + self.ufoOffsetY))
            })
        }),
        cc.CallFunc:create(function(el)
        ...
        cc.MoveTo:create(0.3,cc.p(size.width*0.9,-beerPeople:getContentSize().height + self.ufoOffsetY)),
        cc.CallFunc:create(function(el)
            el:setVisible(false)
        end)
    })
    ...
    self.ufoUpOffsetX = -35
    ufoUp:setVisible(false)
    local ufoUpAction = cc.Sequence:create({
        cc.DelayTime:create(0.3),
        cc.CallFunc:create(function(el)
            el:setAnchorPoint(0.5,0.5)
            el:setPosition(size.width*0.5 + self.ufoUpOffsetX,size.height*0.35 + self.ufoOffsetY)
            el:setScale(0)
            el:setVisible(true)
        end),
        cc.Spawn:create({
            cc.ScaleTo:create(0.4,1),
            cc.Sequence:create({
                cc.MoveTo:create(0.2,cc.p(size.width*0.81 + self.ufoUpOffsetX,size.height*0.47 + self.ufoOffsetY)),
                cc.MoveTo:create(0.1,cc.p(size.width*1.06 + self.ufoUpOffsetX,size.height*0.42 + self.ufoOffsetY)),
                cc.MoveTo:create(0.1,cc.p(size.width*1.11 + self.ufoUpOffsetX,size.height*0.32 + self.ufoOffsetY)),
                cc.MoveTo:create(0.1,cc.p(size.width*1.01 + self.ufoUpOffsetX,size.height*0.19 + self.ufoOffsetY)),
                cc.MoveTo:create(0.1,cc.p(size.width*0.91 + self.ufoUpOffsetX,size.height*0.17 + self.ufoOffsetY))
            })
        }),
        cc.ScaleTo:create(0.1,1,0.8),
        cc.ScaleTo:create(0.1,1),
        cc.CallFunc:create(function(el)
            el:setAnchorPoint(1,0)
            el:setPosition(size.width*0.97 + self.ufoUpOffsetX,size.height*0.15 + self.ufoOffsetY)
        end),
        cc.RotateTo:create(0.2,40),
        cc.RotateTo:create(0.2,0),
        cc.DelayTime:create(7.5),
        cc.MoveTo:create(0.3,cc.p(size.width*0.97,-beerPeople:getContentSize().height + self.ufoOffsetY)),
        cc.CallFunc:create(function(el)
            el:setVisible(false)
        end)
    })
    ...
    self.ufoPeopleOffsetX = 30
    ufoPeople:setVisible(false)
    local ufoPeopleShadow = display.newSprite('#Hotsoon_ufoshadow.png')
    ufoPeopleShadow:setVisible(false)
    ufoPeopleShadow:setPosition(size.width*0.881 + self.ufoPeopleOffsetX - 10,size.height*0.1455 + self.ufoPeopleOffsetY - 20)--
    local ufoPeopleAction = cc.Sequence:create({
        cc.DelayTime:create(1.1),
        cc.CallFunc:create(function(el)
            el:setAnchorPoint(0.5,0.5)
            el:setPosition(size.width*0.90 + self.ufoPeopleOffsetX,size.height*0.13)
            el:setScale(0)
            el:setVisible(true)
        end),
        cc.Spawn:create({
            ...
            cc.Sequence:create({
                cc.MoveTo:create(0.3,cc.p(size.width*0.855 + self.ufoPeopleOffsetX,size.height*0.23 + self.ufoPeopleOffsetY)),
                cc.MoveTo:create(0.1,cc.p(size.width*0.85 + self.ufoPeopleOffsetX,size.height*0.22 + self.ufoPeopleOffsetY)),
                cc.MoveTo:create(0.1,cc.p(size.width*0.865 + self.ufoPeopleOffsetX,size.height*0.18 + self.ufoPeopleOffsetY))
            })
        }),
        cc.CallFunc:create(function(el)
        ...
        cc.Spawn:create({
            cc.Sequence:create({
                 cc.MoveTo:create(0.2,cc.p(size.width*0.865 + self.ufoPeopleOffsetX,size.height*0.17 + self.ufoPeopleOffsetY)),
                 cc.MoveTo:create(0.2,cc.p(size.width*0.865 + self.ufoPeopleOffsetX,size.height*0.18 + self.ufoPeopleOffsetY))
            }),
            cc.Sequence:create({
        ...
        cc.MoveTo:create(0.3,cc.p(size.width*0.865 + self.ufoPeopleOffsetX,-beerPeople:getContentSize().height + self.ufoPeopleOffsetY)),
        cc.CallFunc:create(function(el)
            el:setVisible(false)
        end)
    })
    ...
    local ufoHandAction = cc.Sequence:create({
        ...
        cc.CallFunc:create(function(el)
            el:setAnchorPoint(1,0)
            el:setPosition(size.width*0.84 + self.ufoPeopleOffsetX,size.height*0.17 + self.ufoPeopleOffsetY)
            el:setScale(0)
            el:setRotation(-30)
            el:setVisible(true)
        end),
        cc.Spawn:create({
            cc.Sequence:create({
                 cc.MoveTo:create(0.2,cc.p(size.width*0.84 + self.ufoPeopleOffsetX,size.height*0.17 + self.ufoPeopleOffsetY)),
                 cc.MoveTo:create(0.2,cc.p(size.width*0.84 + self.ufoPeopleOffsetX,size.height*0.18 + self.ufoPeopleOffsetY))
            }),
            cc.ScaleTo:create(0.4,1)
        }),
        ufoHandRotateAction,
        cc.DelayTime:create(0.1),
        cc.MoveTo:create(0.3,cc.p(size.width*0.821 + self.ufoPeopleOffsetX,-beerPeople:getContentSize().height + self.ufoPeopleOffsetY)),
        cc.CallFunc:create(function(el)
            el:setVisible(false)
        end)
    })
    ...
    local ufoFlowerRotateAction = cc.Repeat:create(
        cc.Spawn:create({
            cc.Sequence:create({
                cc.MoveTo:create(0.35,cc.p(size.width*0.84 + self.ufoPeopleOffsetX,size.height*0.187 + self.ufoPeopleOffsetY)),
                cc.MoveTo:create(0.35,cc.p(size.width*0.84 + self.ufoPeopleOffsetX,size.height*0.183 + self.ufoPeopleOffsetY))
            }),
            cc.Sequence:create({
                cc.RotateTo:create(0.35,5),
    ...
    local ufoFlowerAction = cc.Sequence:create({
        ...
        cc.CallFunc:create(function(el)
            el:setAnchorPoint(0.5,0)
            el:setPosition(size.width*0.814 + self.ufoPeopleOffsetX,size.height*0.183)
            el:setScale(0)
            el:setVisible(true)
        end),
        ...
        cc.DelayTime:create(0.1),
        cc.MoveTo:create(0.3,cc.p(size.width*0.814 + self.ufoPeopleOffsetX,-beerPeople:getContentSize().height)),
        cc.CallFunc:create(function(el)
            el:setVisible(false)
        end)
    })
    ...
    local ufoEyeAction = cc.Sequence:create({
        ...
        cc.CallFunc:create(function(el)
            el:setAnchorPoint(0.5,0.5)
            el:setPosition(size.width*0.858 + self.ufoPeopleOffsetX,size.height*0.197 + self.ufoPeopleOffsetY * 1.1)
            el:setScale(0)
            el:setRotation(-10)
            el:setVisible(true)
        end),
        ...
        ufoEyeClickAction,
        cc.DelayTime:create(0.1),
        cc.MoveTo:create(0.3,cc.p(size.width*0.855 + self.ufoPeopleOffsetX,-beerPeople:getContentSize().height)),
        cc.CallFunc:create(function(el)
            el:setVisible(false)
        end)
    })
    ...
    self.music1:setPosition(size.width*0.50,-self.music1:getContentSize().height*2)
    self.music3 = display.newSprite("#Hotsoon_music_beer.png")
    self.music3:setVisible(false)
    self.music3:setPosition(size.width*0.52,-self.music1:getContentSize().height)
    ...
    self.music2:setPosition(size.width*0.78,-self.music2:getContentSize().height*3)
    ...
    vocanoBig0:addChild(vocanoBigLava,2)
    ...
    beatPeople:addChild(beatPeopleRightHand,4)
...
function HotsoonPlanetNode:generateUpBubble()
    --上层气泡
    local up_buble = cc.ParticleSystemQuad:create(self:getResourcePath("up_buble.plist"))
    ...
    local up_bubleAction = cc.Sequence:create({
     ...
     --下落红色花瓣
    local downRed = cc.ParticleSystemQuad:create(self:getResourcePath("down_red.plist"))
    ...
    --下落黄色花瓣
    local downYellow = cc.ParticleSystemQuad:create(self:getResourcePath("down_yellow.plist"))
    ...
    --下落大圆点
    local downBig = cc.ParticleSystemQuad:create(self:getResourcePath("down_big.plist"))
...
function HotsoonPlanetNode:generateVolcanoBubble(height)
    --火山口气泡
    local volcano_buble = cc.ParticleSystemQuad:create(self:getResourcePath("volcano_buble.plist"))
    ...
    --大火山腰部气泡
    local yellow_buble = cc.ParticleSystemQuad:create(self:getResourcePath("yellow_buble.plist"))
    ...
    --小火山腰部气泡
    local yellow_buble2 = cc.ParticleSystemQuad:create(self:getResourcePath("yellow_buble2.plist"))
...
function HotsoonPlanetNode:generateBubble()
    -- 火山灰
    local tephra = cc.ParticleSystemQuad:create(self:getResourcePath("tephra.plist"))
    ...
    -- 黄色气泡
    local downYellowBuble = cc.ParticleSystemQuad:create(self:getResourcePath("down_yellow_buble.plist"))
    downYellowBuble:setAnchorPoint(0.5,0)
    downYellowBuble:setPosition(display.size.width*0.2,display.size.height*0.19)

    -- 红色气泡
    local downRedBuble = cc.ParticleSystemQuad:create(self:getResourcePath("down_red_buble.plist"))
    ...
    --右侧跳出气泡
    local rightup_buble = cc.ParticleSystemQuad:create(self:getResourcePath("rightup_buble.plist"))
    ...
    --左侧跳出气泡
    local leftup_buble = cc.ParticleSystemQuad:create(self:getResourcePath("leftup_buble.plist"))
    ...
    --背景白色的气泡
    local snowlike_buble = cc.ParticleSystemQuad:create(self:getResourcePath("snowlike_buble.plist"))
...
function HotsoonPlanetNode:onExit()
    ...
    display.removeSpriteFrames(self:getResourcePath("HotsoonPlanet.plist"), self:getResourcePath("HotsoonPlanet.png"))
    display.removeSpriteFrames(self:getResourcePath("HotsoonMouth.plist"), self:getResourcePath("HotsoonMouth.png"))
    display.removeSpriteFrames(self:getResourcePath("HotsoonBeerPeople.plist"), self:getResourcePath("HotsoonBeerPeople.png"))
end
...
function HotsoonPlanetNode:create(layer, msg)
    local node = HotsoonPlanetNode.new(layer, msg) 
    node:init()
    return node
end
