...
function BearNode:init()
    ...
    :align(display.CENTER, display.cx, height)
    :setOpacity(0)
    ...
    :setPosition(0.255 * width, 0.153 * height)
    :setOpacity(0)
    ...
    :align(display.LEFT_BOTTOM, 0.24 * width, 0.165 * height)
    :setScale(0.4)
    :setOpacity(0)
    ...
    :align(display.RIGHT_TOP, 0.21 * width, 0.125 * height)
    :setOpacity(0)
    ...
    :align(cc.p(0, 0.6), 0.28 * width, 0.14 * height)
    :setOpacity(0)
    :setLocalZOrder(-1)
    ...
    :setPosition(0.18 * width, 0.176 * height)
    :setOpacity(0)
    ...
    :setPosition(0.24 * width, 0.195 * height)
    :setOpacity(0)
