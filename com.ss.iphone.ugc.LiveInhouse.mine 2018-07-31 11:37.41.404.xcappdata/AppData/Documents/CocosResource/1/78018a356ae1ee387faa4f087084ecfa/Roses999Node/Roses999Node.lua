...
function Roses999Node:create(layer, msg)
    local node = Roses999Node.new(layer, msg)
    node:init()
    return node
end

function Roses999Node:init()
    display.loadSpriteFrames(self:getResourcePath("roses_999_swing.plist"), self:getResourcePath("roses_999_swing.png"))
    display.loadSpriteFrames(self:getResourcePath("roses_999.plist"), self:getResourcePath("roses_999.png"))
...
function Roses999Node:createRotatePetal()
     local petalRotate1 = cc.ParticleSystemQuad:create(self:getResourcePath("rotate58.plist"))
     local petalRotate2 = cc.ParticleSystemQuad:create(self:getResourcePath("rotate68.plist"))
     local petalRotate3 = cc.ParticleSystemQuad:create(self:getResourcePath("rotate78.plist"))
...
function Roses999Node:createPetal()
     local petal1 = cc.ParticleSystemQuad:create(self:getResourcePath("fullFlower91.plist"))
     local petal2 = cc.ParticleSystemQuad:create(self:getResourcePath("fullFlower95.plist"))
     local petal3 = cc.ParticleSystemQuad:create(self:getResourcePath("downHeart4.plist"))
...
function Roses999Node:onExit() 
     ...
     display.removeSpriteFrames(self:getResourcePath("roses_999_swing.plist"), self:getResourcePath("roses_999_swing.png"))
     display.removeSpriteFrames(self:getResourcePath("roses_999.plist"), self:getResourcePath("roses_999.png"))
end
