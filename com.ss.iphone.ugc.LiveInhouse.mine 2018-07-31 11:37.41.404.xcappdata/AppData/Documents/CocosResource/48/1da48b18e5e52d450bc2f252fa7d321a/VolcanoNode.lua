...
function VolcanoNode:init()
    ...
    local ownerAction = cc.Sequence:create({
        ...
        cc.EaseIn:create(cc.MoveTo:create(0.4, cc.p(display.cx, 0.5 * volcanoHeight + 200)),2.0),

        cc.DelayTime:create(1.4),

        cc.MoveTo:create(2, cc.p(display.cx, yellowWaveHeight + 0.55 * volcanoHeight + 200)),
